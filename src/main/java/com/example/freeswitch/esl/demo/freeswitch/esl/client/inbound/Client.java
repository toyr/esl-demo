 ...
 */
package com.example.freeswitch.esl.demo.freeswitch.esl.client.inbound;

import com.example.freeswitch.esl.demo.freeswitch.esl.client.IEslEventListener;
import com.example.freeswitch.esl.demo.freeswitch.esl.client.internal.IEslProtocolListener;
...
public class Client {
    ...
    private static final NioClientSocketChannelFactory nioClientSocketChannelFactory = new NioClientSocketChannelFactory(
